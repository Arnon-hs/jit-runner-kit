...
The project source is licensed under MIT. It does not vendor the tools below, but operators and contributors download or invoke them. This inventory is technical compliance information, not legal advice.
